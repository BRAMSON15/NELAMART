...
<head>
    ...
    <meta name="description" content="Kelola Pesanan - NELA MART" />
    <meta name="author" content="" />
    <title>Kelola Pesanan - NELA MART</title>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{ route('admin.kelola-produk') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-box"></i></div>
                            Kelola Produk
                        </a>
                        <a class="nav-link active" href="{{ route('admin.kelola-pesanan') }}">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    @forelse(\App\Models\Pesanan::with('user')->get() as $pesanan)
                                    <tr>
                                        <td>{{ $pesanan->id }}</td>
