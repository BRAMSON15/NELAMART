...
<head>
    ...
    <meta name="description" content="Kelola User - NELA MART" />
    <meta name="author" content="" />
    <title>Kelola User - NELA MART</title>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.user.detail', $user->id) }}" class="btn btn-sm btn-info" title="Detail">
