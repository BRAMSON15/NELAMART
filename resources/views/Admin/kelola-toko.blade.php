...
<head>
    ...
    <meta name="description" content="Kelola Toko - NELA MART" />
    <meta name="author" content="" />
    <title>Kelola Toko - NELA MART</title>
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            @if($toko->status == 'pending')
                                                <form action="{{ route('admin.toko.approve', $toko->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-success" title="Approve" onclick="return confirm('Setujui toko ini?')">
                                                        <i class="fas fa-check"></i>
                                                    </button>
                                                </form>
                                                <form action="{{ route('admin.toko.reject', $toko->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-danger" title="Reject" onclick="return confirm('Tolak toko ini?')">
                                            ...
                                            @elseif($toko->status == 'aktif')
                                                <form action="{{ route('admin.toko.reject', $toko->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-warning" title="Nonaktifkan" onclick="return confirm('Nonaktifkan toko ini?')">
                                            ...
                                            @else
                                                <form action="{{ route('admin.toko.approve', $toko->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-success" title="Aktifkan" onclick="return confirm('Aktifkan toko ini?')">
                                                        <i class="fas fa-check"></i>
                                                    </button>
                                                </form>
                                            @endif
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="8" class="text-center">Tidak ada data toko</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
